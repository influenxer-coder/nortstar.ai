...
import { Instrument_Serif, DM_Sans, DM_Mono, Inter } from 'next/font/google'
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${serif.variable} ${dmSans.variable} ${dmMono.variable} ${inter.variable}`}>
