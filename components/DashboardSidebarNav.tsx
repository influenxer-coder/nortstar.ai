...
function AgentRow({ agent, isActive }: { agent: AgentStub; isActive: boolean }) {
  ...
  return (
    <div className="group relative flex items-center">
      <Link
        ...
        className={`flex-1 flex items-center gap-2.5 rounded-md pl-6 pr-2 py-1.5 text-xs transition-colors min-w-0 ${
...
export function DashboardSidebarNav({ products, ungroupedAgents }: Props) {
  ...
  return (
    <div className="space-y-1">
      ...
      {/* Products with agents under each */}
